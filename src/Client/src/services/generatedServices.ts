...
export class Client {
    ...
    protected processResourcesGet(response: Response): Promise<Resources> {
        ...
        return Promise.resolve<Resources>(null as any);
    }
    ...
    protected processTreeGet(response: Response): Promise<Tree> {
        ...
        return Promise.resolve<Tree>(null as any);
    }
    ...
    protected processTreeNodeGet(response: Response): Promise<Node> {
        ...
        return Promise.resolve<Node>(null as any);
    }
     ...
     * @return Success
     */
    treeNodeGetPrettyPrint(treeId: string): Promise<Text> {
    ...
    protected processTreeNodeGetPrettyPrint(response: Response): Promise<Text> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<Text>(null as any);
    }
